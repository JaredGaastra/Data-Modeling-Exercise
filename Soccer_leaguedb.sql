...
-- Last modification date: 2023-04-26 22:55:24.579
...
-- Reference: teams_Matchs (table: teams)
ALTER TABLE teams ADD CONSTRAINT teams_Matchs FOREIGN KEY teams_Matchs (Matchs_match_id)
    REFERENCES Matchs (match_id);

-- Reference: teams_Standings (table: teams)
ALTER TABLE teams ADD CONSTRAINT teams_Standings FOREIGN KEY teams_Standings (Standings_standing_id)
    REFERENCES Standings (standing_id);

-- Reference: teams_players (table: teams)
ALTER TABLE teams ADD CONSTRAINT teams_players FOREIGN KEY teams_players (players_player_id)
